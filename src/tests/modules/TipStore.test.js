...
describe('TipStore', () => {
    ...
    describe('removeTip', () => {
        ...
        it('removes tip from appropriate group.tips', () => {
            ...
            expect(TipStore._tipState.groupedTips[3].tips.includes(targetTip)).toBe(true);

            TipStore.removeTip(targetTip);
            expect(TipStore._tipState.groupedTips[3].tips.includes(targetTip)).toBe(false);
        });
    });
    ...
    describe('editTip', () => {
        ...
        it('replaces old tip with new tip containing the correct values', () => {
            TipStore.addTip(tip);
            const newValues = { amount: 200, date: '2025-01-05', type: 'Banquet', shift: 'Dinner' };
